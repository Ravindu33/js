...
function nd() {
    ...
    x.style = "width: 50px;height: 50px;background-color: black;border-radius: 15px;position: fixed;top: 40px;right: 20px;color: white;object-fit: contain;padding:1px;z-index:3;";
    x.setAttribute("onclick","DON()");
    var y = document.createElement("div");
    y.id = "HC";
    y.style = "color: white;display:none;position: fixed;width: 100%;height:50%;bottom: 5px;background: black;margin: 0px;left: 0px;overflow-x:hidden ;overflow-y:visible;border-radius:20px;z-index:3;";
