...
function nd() {
    ...
    z.style = "color:black; background-color:white;margin-left:8px;";
    a.style = "color:black;background-color:white;margin-left:8px;";
    v.style = "color:black;background-color:white;margin-left:8px;";
